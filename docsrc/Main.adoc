...
StartVessel direction ->
    case newVessel model.wets_popname direction of
        Nothing ->
            ( { model
    ...
    Svg.svg
        ...
        (List.append
            [ Svg.rect
                ...
                []
            , UI.chamber 0 40
            , animChamber "AChamber" model 200
            , UI.chamber 400 80
...
off-stage to assist in the entry and exit animation.
    ...
    , toPosition =
        \tstate ->
            case tstate of
                ...
                AChamberLow  -> Util.Position 300.0 80.0
                AChamberHigh -> Util.Position 300.0 40.0
                BChamberLow  -> Util.Position 300.0 80.0
                BChamberHigh -> Util.Position 300.0 40.0
                UpperGate    -> Util.Position 100.0 40.0
                UpperEntry   -> Util.Position -70.0 40.0
                _ -> Util.Position 0.0 0.0
    }
