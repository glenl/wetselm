...
* The _Chamber_ locations are employed for both vessel and chamber animations.
...
flowTarget tstate =
    case tstate of
        AChamberHigh -> Just ( ChamberFlow "Chamber-01" Low )
        AChamberLow  -> Just ( ChamberFlow "Chamber-01" High )
        _ -> Nothing
----
